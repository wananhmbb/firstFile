...
import { LAST_USER_INFO } from "@/config/cache"
import { ACCESS_TOKEN, USER_INFO } from "@/const/storage-key"

const state = {
  token: uni.getStorageSync(ACCESS_TOKEN) || "",
  backgroundColor: "#fff",
  userInfo: uni.getStorageSync(USER_INFO)
    ? uni.getStorageSync(LAST_USER_INFO)
    : null,
  uid: uni.getStorageSync(LAST_USER_INFO).id || null,
  homeActive: false,
