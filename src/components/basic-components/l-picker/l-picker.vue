  ...
  >
    <view class="u-datetime-picker">
      ...
      <view class="u-picker-body">
        <picker-view
          v-if="mode == 'time'"
          mask-style="background: var(--bg-color-main);z-index:0"
        ...
        >
          <picker-view-column v-if="!reset && params.year">
            <view
              ...
              :key="index"
              :class="index == valueArr[0] ? 'u-column-item1' : 'u-column-item'"
            >
              {{ item }}
          ...
          <picker-view-column v-if="!reset && params.month">
            <view
              :class="index == valueArr[1] ? 'u-column-item1' : 'u-column-item'"
          ...
          <picker-view-column v-if="!reset && params.day">
            <view
              :class="index == valueArr[2] ? 'u-column-item1' : 'u-column-item'"
