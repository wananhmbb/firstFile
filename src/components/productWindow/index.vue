<template>
	<view  >
		<view class="product-window"
			...
			<view class="textpic acea-row row-between-wrapper flex-left">
				<view class="pictrue">
			...
			<view class="rollTop">
				<view class="productWinList">
					<view class="item" v-for="(item, indexw) in attr.productAttr" :key="indexw">
						...
						<view class="listn acea-row row-middle flex-left">
				...
				<view class="cart acea-row row-between-wrapper">
					...
					<view class="carnum acea-row row-left flex-right">
		...
		<view  :class=" [attr.cartAttr === true ? 'large' : '']"  @touchmove.prevent :hidden="attr.cartAttr === false" @click="closeAttr"></view>
	</view>
</template>
...
.large{
	...
	.product-window.on {
		transform: translateY(calc(100% - 100% - 100rpx - env(safe-area-inset-bottom)))
