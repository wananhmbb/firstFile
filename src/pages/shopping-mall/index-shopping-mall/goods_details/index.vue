<template>
  ...
  <theme>
    <view class="product-con" slot="theme">
      <house-header headTypeTwo="商品详情"></house-header>
      ...
      <view v-if="productInfo && !detailLoading">
        ...
        <view>
          ...
          >
              ...
              <view class="pad30">
                <view class="wrapper mb30 borRadius14 row-background">
                  ...
                  <view class="product-introduction">
                    {{ productInfo.storeInfo[0].desc || "暂无描述" }}
                  </view>
                    ...
                    <view class="moreBox">
                      <view class="use-method"
                        ><text
                          ...
                          "
                          >{{
                            productInfo.storeInfo[0].hint || "暂无提示"
                          }}</text
                        ></view
                      >
                      <view class="iconBox"
            ...
            <view
              style="height: calc(100rpx + env(safe-area-inset-bottom))"
            ></view>
          </scroll-view>
        </view>
        <!-- <u-popup
...
export default {
  ...
  onLoad(options) {
    ...
    this.useDirection = options.useDirection
      ? JSON.parse(decodeURIComponent(options.useDirection))
      : ""
    this.healthTips = options.healthTips
      ? JSON.parse(decodeURIComponent(options.healthTips))
      : ""
    this.servicePackageId = options.servicePackageId
      ? options.servicePackageId
      : 0
  ...
  methods: {
      ...
      getProductDetail(that.id, that.type)
        .then(res => {
          if (res.code == 200) {
            ...
            that.productInfo.storeInfo = JSON.parse(that.productInfo.storeInfo)
    ...
    DefaultSelect: function () {
      ...
      //sort();排序函数:数字-英文-汉字；
      console.log(this.productValue, "11111")
    ...
    getPreOrder: function () {
      ...
      this.$Order
        .getProductPreOrder(this.type === "normal" ? "buyNow" : "video", [
          {
